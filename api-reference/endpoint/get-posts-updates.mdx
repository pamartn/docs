...
<Expandable title="Post object">
  ...
  <ResponseField name="profile" type="object" required>
    Information about the post author. All fields are always present. This field is especially useful for differentiating posts from different profiles in the aggregated response.
