...
const response = await fetch(
  'https://your-domain.com/api/v1/profile?profileUrlOrUrn=https://www.linkedin.com/in/williamhgates',
  {
    headers: {
      'X-API-Key': 'your-api-key-here'
    }
...
$url = "https://your-domain.com/api/v1/profile?profileUrlOrUrn=" . urlencode($profileUrl);
...
<Info>
  This endpoint counts as 1 request toward your monthly quota.
</Info>
